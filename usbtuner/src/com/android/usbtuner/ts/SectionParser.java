...
public class SectionParser {
    ...
    private static final byte TABLE_ID_NIT = (byte) 0x40;
    ...
    private void parseSection(byte[] data) {
        ...
        //Log.d(TAG, "Section versionNumber:" + versionNumber);
        ...
        switch (data[0]) {
            case TABLE_ID_PAT:
                Log.d(TAG, "Section TABLE_ID_PAT");
                result = parsePAT(data);
                break;
            case TABLE_ID_CAT:
                Log.d(TAG, "Section TABLE_ID_CAT");
                //result = parsePMT(data);
                break;
            case TABLE_ID_NIT:
                Log.d(TAG, "Section TABLE_ID_NIT");
                //result = parsePMT(data);
                break;
            case TABLE_ID_SDT:
                Log.d(TAG, "Section TABLE_ID_SDT");
                result = parseSDT(data);
                break;
            case TABLE_ID_PMT:
                Log.d(TAG, "Section TABLE_ID_PMT");
                result = parsePMT(data);
                break;
            case TABLE_ID_MGT:
                Log.d(TAG, "Section TABLE_ID_MGT");
                result = parseMGT(data);
                break;
            case TABLE_ID_TVCT:
            case TABLE_ID_CVCT:
                Log.d(TAG, "Section TABLE_ID_VCT");
                result = parseVCT(data);
                break;
            case TABLE_ID_EIT:
                Log.d(TAG, "Section TABLE_ID_EIT");
                result = parseEIT(data);
                break;
            case TABLE_ID_ETT:
                Log.d(TAG, "Section TABLE_ID_ETT");
                result = parseETT(data);
                break;
            default:
                Log.d(TAG, "Section TABLE_ID_UNKNOWN:" + data[0]);
                break;
        }
        if (result) {
    ...
    private static boolean parseSDT(byte[] data) {
